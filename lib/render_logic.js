...
function renderBidStratLast(element, precision) {
    const myElement = document.getElementById(`${roundtext(element.price, precision)}-bid`);
    myElement.setAttribute('class', `cell bidTDLastTrade`);
}

function renderAskStratLast(element, precision) {
    const myElement = document.getElementById(`${roundtext(element.price, precision)}-ask`);
    myElement.setAttribute('class', `cell askTDLastTrade`);
}
